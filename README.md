...
# Note: It is recommended running script on a daily basis. According to Tecent, they will mostly likely to update data between 7:00  - 10:00 am UTC+8, so it's better to run the script is after 10:00 am UTC+ 8 #
